...
namespace ComplexWaveFunctionCollapse2D
{
    public class PatternManager
    {
        ...
        public void ProcessGrid<T>(ValuesManager<T> valuesManager, bool equalsWeight,bool wrap, string strategyName = null)
        {
            ...
            CreatePatterns(valuesManager,strategy,equalsWeight,wrap);
        }
        ...
        private void CreatePatterns<T>(ValuesManager<T> valuesManager, IFIndNeighborStrategy strategy, bool equalsWeight,bool wrap)
        {
            PatternDataResult patternFinderResult = PatternFinder.GetPatternDataFromGrid<T>(valuesManager, patternSize, equalsWeight,wrap);
            //Debug.Log(patternFinderResult.GetGridLengthY());
            //Debug.Log(patternFinderResult.GetGridLengthX());
            // TESTING CODE
